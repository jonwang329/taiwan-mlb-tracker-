...
- Dashboard repaint aligns every tracked player with a safe result object, preventing a transient observation-list refresh from throwing on a missing result.
