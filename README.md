...
- The primary season stat (AVG for hitters, ERA for pitchers) can show one restrained gray league-context line such as `8% better vs league`, `6% worse vs league`, or `≈ league avg`.
