...
document.querySelector('#refresh-btn').addEventListener('click',async e=>{e.currentTarget.textContent='更新中…';await renderPlayers();e.currentTarget.textContent='✓ 已更新';setTimeout(()=>e.currentTarget.textContent='↻ 更新資料',1400);});
renderPlayers();
