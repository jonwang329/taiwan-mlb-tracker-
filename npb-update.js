(()=>{
  ...
  const japanPlayers=[
    {name:'古林睿煬',team:'北海道日本火腿鬥士',role:'投手',level:'二軍',stats:[['8','G'],['28.1','IP'],['33','K'],['4.45','ERA']],note:'目前為二軍狀態。NPB 官方二軍 2026 成績：8 場、28.1 局、33K、ERA 4.45；不要再沿用舊的一軍標籤。',source:'https://npb.jp/bis/2026/stats/idp2_f.html'},
    ...
    {name:'林安可',team:'埼玉西武獅',role:'野手',level:'一軍',stats:[['.229','AVG'],['49','H'],['8','HR'],['28','RBI']],today:'09/06 vs 軟銀 · 4 AB · 2 H · 1 HR · 1 RBI',note:'Today’s Game 優先顯示當日實際出賽。今天 4 打數 2 安打，包含陽春砲；本季第 8 轟、第 28 打點。',source:'https://npb.jp/bis/players/33935152.html'},
