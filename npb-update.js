(()=>{
  ...
  const japanPlayers=[
    ...
    {name:'林安可',team:'埼玉西武獅',role:'野手',level:'一軍',stats:[['.229','AVG'],['47+','H'],['8','HR'],['28','RBI']],today:'09/06 vs 軟銀 · 先發第6棒 DH · 2安打（內野安打、陽春砲）· 第8轟 · 1 RBI',note:'Today’s Game 優先顯示當日實際出賽；今天首局敲安、6局再轟陽春砲。固定追蹤安打、長打、上壘率與三振/保送趨勢。',source:'https://npb.jp/bis/players/33935152.html'},
  ...
  // A fresh/reopened visit always starts from the primary MLB page.
  // Japan/Asia is a temporary viewing mode, not persistent navigation state.
  setPage('mlb');
})();